########################
Introducción a MapleSim
########################

**MapleSim** es una librería desarrollada por el equipo de Shenzhen Robotics. Esta librería implementa
...
Características de MapleSim
****************************

**MapleSim** implementa muchas funcionalidades nuevas, entre las cuales destacan:

- Motor de físicas realistas

- Simulación de motores

- Simulación de **gamepieces** y **field elements**

- Simulación de **scoring**.

- Simulación de robots enemigos.

- Facilidades para simular la swerve y sus funcionalidades.
